...
const Orders = () => {
  return (
    <main>
      ...
      <h2>Desert Boxes</h2>
      <p>
        We hand-make all our desserts freshly in store for you to enjoy. Choose
        your favourite flavours and create your very own dessert box!
      </p>
      <label>
      ...
      <p>
        PLEASE NOTE THAT ALL ORDERS MUST BE PLACES AT LEAST 24 HOURS BEFORE YOU
        WANT TO RECEIVE YOUR ORDER this is due to all products being made fresh
        in store. YOUR ORDER WILL ONLY BE CONFIRMED ONCE A MEMBER OF STAFF
        CONTACTS YOU TO TAKE PAYMENT OVER THE PHONE
      </p>
    </main>
  );
};
