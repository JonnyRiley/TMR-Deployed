  ...
  return (
    <main className="FAQMain">
      ...
      <p className="FAQ">
        ...
        <br></br> <br></br>
        <p className="FAQBold">I’M VEGAN. WHAT YOU GOT FOR ME?</p> <br></br>
        We can make our shakes vegan-friendly! Swap our ice cream to soya ice
        cream and enjoy a delicious milkshake or Ice Cream sundae. We also have
        free from chocolate that can be added to your meal and plenty of fresh
        fruit! <br></br> <br></br>
        <p className="FAQBold">I’VE GOT NUT ALLERGIES. CAN I STILL COME?</p> 
        <br></br>
        Yes! We have a selection of nut-free offerings and take allergies very
        ...
        furry friends but unfortunately due to the shop being small we don’t
        allow dogs inside. However, we do have lots of outside seating where
        dogs can sit and chill with their owners. Just ask a member of the team
        for a water bowl and some complimentary ice cream for your doggie to
        enjoy!<br></br>
        <br></br>
        <p className="FAQBold">TRYING TO CONTACT US?</p> <br></br>
        Telephone: 01704 829547 <br></br>
        Email: hello@themilkroom.com <br></br>
        Contact us on Facebook and Instagram too!! <br></br> <br></br>
        <p className="FAQBold">WHERE ARE YOU LOCATED?</p> <br></br>
