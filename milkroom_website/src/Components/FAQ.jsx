  ...
  return (
    <main className="FAQMain">
      ...
      <p className="FAQ">
        ...
        <br></br> <br></br>
        I’M VEGAN. WHAT YOU GOT FOR ME? <br></br>
        <br></br>
        ...
        fruit! <br></br> <br></br>
        I’VE GOT NUT ALLERGIES. CAN I STILL COME? <br></br>
        <br></br>
        ...
        CAN I GET MY FOOD DELIVERED? <br></br>
        <br></br>
